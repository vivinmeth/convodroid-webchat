  ...
  return {
    ...
    entry:
      isEnvDevelopment && !shouldUseReactRefresh
        ...
        : isEnvDevelopment ? paths.appIndexDevJs : paths.appIndexJs,
    output: {
      // The build folder.
    ...
    resolve: {
      ...
      alias: {
        ...
        react: path.resolve(__dirname, '../src/isomorphic-react/dist/react.js'),
        'react-dom': path.resolve(__dirname, '../src/isomorphic-react-dom/dist/react-dom.js')
      },
      plugins: [
    ...
    plugins: [
      ...
      new webpack.DefinePlugin({
          publicPath: JSON.stringify(paths.publicUrlOrPath),
      }),
    ].filter(Boolean),
